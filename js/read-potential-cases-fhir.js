...
(async () => {
  ...
  await fs.writeFile("lithium-drug-codes-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("lithium-drug-codes-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
